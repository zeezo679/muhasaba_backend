...
<execution_context>
@~/.gemini/antigravity/gsd-core/workflows/mvp-phase.md
@~/.gemini/antigravity/gsd-core/references/spidr-splitting.md
@~/.gemini/antigravity/gsd-core/references/user-story-template.md
</execution_context>
...
<process>
Execute the mvp-phase workflow from @~/.gemini/antigravity/gsd-core/workflows/mvp-phase.md end-to-end.
